...
exports.getListUniProtMySQL = function( req, res ){
	...
	mysqlqueries.getPool( config, function( pool ) {
		...
		mysqlqueries.getUniProt( pool, listarray, res, function( mapping ) {
			...
			if ( values.length > 0 ) {
				...
				mysqlqueries.getUniProtGOA( pool, values, method, res, function( outcome ) {

					functions.returnJSON( res, { "outcome": outcome, "query": mapping, "method": method } );
